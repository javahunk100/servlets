...
<body style="background-image: url('img/backgrounds.jpg');">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  name="name" readonly="readonly" value="${sessionScope.username}"/>
      ...
      <input type="text" class="form-control"  name="email" readonly="readonly" value="${sessionScope.password}"/>
